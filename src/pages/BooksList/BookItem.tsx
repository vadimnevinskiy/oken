          ...
          <div className="card-content">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: book.description.slice(0, 80),
              }}
            ></div>
          </div>
          <div className="card-action">
            <NavLink to={`/detail/${book.id}`} className="waves-effect waves-light btn-small">
              Detail
            </NavLink>
            <a
              onClick={() => deleteItem(book.id)}
              className="waves-effect waves-light btn-floating btn-small right"
            >
